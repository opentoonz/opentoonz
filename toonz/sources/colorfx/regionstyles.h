...
class MovingModifier : public TOutlineStyle::RegionOutlineModifier
{
  ...
  public:
	...
	void saveData(TOutputStreamInterface &os) const { os << m_move.x << m_move.y; }
};
...
class DVAPI ShadowStyle : public TSolidColorStyle
{
  ...
  public:
	ShadowStyle(const TPixel32 &bgColor, const TPixel32 &shadowColor,
				const TPointD &shadowDirection = TPointD(-1, -1), double len = 30.0,
				double density = 0.4);
...
class DVAPI ShadowStyle2 : public TSolidColorStyle
{
  ...
  public:
	ShadowStyle2(const TPixel32 &bgColor, const TPixel32 &shadowColor,
				 const TPointD &shadowDirection = TPointD(-1, -1), double shadowLength = 70.0);
  ...
  private:
	void drawPolyline(const TColorFunction *cf, const std::vector<T3DPointD> &polyline,
					  TPointD shadowDirection) const;
	int drawPolyline(TFlash &flash, std::vector<T3DPointD> &polyline, TPointD shadowDirection,
					 const bool isDraw = true) const;
};
...
class DVAPI TPointShadowFillStyle : public TSolidColorStyle
{
  ...
  public:
	TPointShadowFillStyle(const TPixel32 &bgColor, const TPixel32 &shadowColor,
						  const TPointD &shadowDirection = TPointD(-1, -1), double density = 0.1,
						  double shadowSize = 30.0, double pointSize = 5.0);
  ...
  */
	...
	QString getDescription() const
	{
		return QCoreApplication::translate("TPointShadowFillStyle", "Sponge Shading");
	}
  ...
  private:
	...
	void shadowOnEdge_parallel(const TPointD &p0, const TPointD &p1, const TPointD &p2,
							   TRandom &rnd) const;
	int shadowOnEdge_parallel(TFlash &flash, const TPointD &p0, const TPointD &p1,
							  const TPointD &p2, TRandom &rnd, const double radius,
							  const bool isDraw) const;

	void deleteSameVerts(TRegionOutline::Boundary::iterator &rit, std::vector<T3DPointD> &pv) const;
};
...
class DVAPI TDottedFillStyle : public TSolidColorStyle
{
  ...
  public:
	TDottedFillStyle(const TPixel32 &bgColor, const TPixel32 &pointColor, const double dotSize,
					 const double dotDist, const bool isShifted);
  ...
  */
  ...
  private:
	int nbClip(const double LDotDist, const bool LIsShifted, const TRectD &bbox) const;
};
...
class DVAPI TCheckedFillStyle : public TSolidColorStyle
{
  ...
  public:
	TCheckedFillStyle(const TPixel32 &bgColor, const TPixel32 &pointColor, const double HDist,
					  const double HAngle, const double VDist, const double VAngle,
  ...
  */
  ...
  private:
	void getHThickline(const TPointD &lc, const double lx, TPointD &p0, TPointD &p1, TPointD &p2,
					   TPointD &p3) const;
	void getVThickline(const TPointD &lc, const double ly, TPointD &p0, TPointD &p1, TPointD &p2,
					   TPointD &p3) const;
...
class ArtisticModifier : public TOutlineStyle::RegionOutlineModifier
{
  ...
  public:
	ArtisticModifier(const TPointD &point, double period) : m_move(point), m_period(period) {}

	TOutlineStyle::RegionOutlineModifier *clone() const;

	void loadData(TInputStreamInterface &is) { is >> m_move.x >> m_move.y >> m_period; }
	void saveData(TOutputStreamInterface &os) const { os << m_move.x << m_move.y << m_period; }
...
class DVAPI TChalkFillStyle : public TSolidColorStyle
{
  ...
  public:
	TChalkFillStyle(const TPixel32 &color0, const TPixel32 &color1, const double density,
					const double size);
...
class DVAPI TChessFillStyle : public TSolidColorStyle
{
  ...
  public:
	TChessFillStyle(const TPixel32 &bgColor, const TPixel32 &pointColor, const double HDist,
  ...
  */
  ...
  private:
	void makeGrid(TRectD &bbox, TRotation &rotM, std::vector<TPointD> &grid, int &nbClip) const;
};
...
class DVAPI TStripeFillStyle : public TSolidColorStyle
{
  ...
  public:
	TStripeFillStyle(const TPixel32 &bgColor, const TPixel32 &pointColor, const double Dist,
  ...
  */
  ...
  private:
	void getThickline(const TPointD &lc, const double ly, TPointD &p0, TPointD &p1, TPointD &p2,
					  TPointD &p3) const;
	int nbClip(const TRectD &bbox) const;
};
...
class DVAPI TLinGradFillStyle : public TSolidColorStyle
{
  ...
  public:
	TLinGradFillStyle(const TPixel32 &bgColor, const TPixel32 &pointColor, const double Angle,
					  const double XPos, const double YPos, const double Size);
  ...
  */
  ...
  private:
	void getRects(const TRectD &bbox, std::vector<TPointD> &r0, std::vector<TPointD> &r1,
...
class DVAPI TRadGradFillStyle : public TSolidColorStyle
{
  ...
  public:
	TRadGradFillStyle(const TPixel32 &bgColor, const TPixel32 &pointColor, const double XPos,
					  const double YPos, const double Radius, const double Smooth);
...
class DVAPI TCircleStripeFillStyle : public TSolidColorStyle
{
  ...
  public:
	TCircleStripeFillStyle(const TPixel32 &bgColor, const TPixel32 &pointColor, const double XPos,
  ...
  */
  ...
  private:
	void getCircleStripeQuads(const TPointD &center, const double r1, const double r2,
...
class DVAPI TMosaicFillStyle : public TSolidColorStyle
{
  ...
  public:
	TMosaicFillStyle(const TPixel32 &bgColor, const TPixel32 pointColor[4], const double size,
					 const double deform, const double minThickness, const double maxThickness);
  ...
  */
  ...
  private:
	void preaprePos(const TRectD &box, std::vector<TPointD> &v, int &lX, int &lY,
					TRandom &rand) const;
	bool getQuad(const int ix, const int iy, const int lX, const int lY, std::vector<TPointD> &v,
...
class DVAPI TPatchFillStyle : public TSolidColorStyle
{
  ...
  public:
	TPatchFillStyle(const TPixel32 &bgColor, const TPixel32 pointColor[6], const double size,
					const double deform, const double thickness);
  ...
  private:
	void preaprePos(const TRectD &box, std::vector<TPointD> &v, int &lX, int &lY,
					TRandom &rand) const;
	bool getQuadLine(const TPointD &a, const TPointD &b, const double thickn, TPointD *quad) const;
