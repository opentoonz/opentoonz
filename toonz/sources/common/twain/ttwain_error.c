...
#else
const char *RC_msg[] = {"TWRC_SUCCESS",			"TWRC_FAILURE",   "TWRC_CHECKSTATUS ('tried hard')",
...
void TTWAIN_RecordError(void)
{
	...
	if ((TTwainData.ErrRC == TWRC_FAILURE) || (TTwainData.ErrRC == TWRC_CHECKSTATUS))
