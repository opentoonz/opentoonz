...
#define INTERNAL_LOOP_THE_FIRST                                                                    \
	...
	rCol = (unsigned char)((yWeight0 * rColDownTmp + yWeight1 * rColUpTmp) >> PADN);               \
	gCol = (unsigned char)((yWeight0 * gColDownTmp + yWeight1 * gColUpTmp) >> PADN);               \
	bCol = (unsigned char)((yWeight0 * bColDownTmp + yWeight1 * bColUpTmp) >> PADN);               \
