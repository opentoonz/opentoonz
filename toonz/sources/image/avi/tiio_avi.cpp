...
{
	switch (rc) {
		CASE AVIERR_BADFORMAT : return "The file couldn't be read, indicating a corrupt file or an "
									   "unrecognized format.";
		...
		CASE REGDB_E_CLASSNOTREG : return "According to the registry, the type of file specified "
										  "in m_aviFileOpen does not have a handler to process it.";
