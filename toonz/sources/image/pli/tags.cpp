...
TextTag::TextTag(const TextTag &textTag) : PliObjectTag(textTag), m_text(textTag.m_text)
{
}

/*=====================================================================*/

TextTag::TextTag(const std::string &text) : PliObjectTag(PliTag::TEXT), m_text(text)
{
}
...
PaletteTag::PaletteTag() : PliTag(PliTag::PALETTE), m_numColors(0), m_color(NULL)
{
}

/*=====================================================================*/

PaletteTag::PaletteTag(TUINT32 numColors, TPixelRGBM32 *color) : PliTag(PliTag::PALETTE)
{
...
GroupTag::GroupTag() : PliObjectTag(PliTag::GROUP_GOBJ), m_type(GroupTag::NONE), m_numObjects(0)
{
}
...
StyleTag::StyleTag() : PliObjectTag(PliTag::STYLE_NGOBJ), m_id(0), m_numParams(0), m_pageIndex(0)
{
}
...
StyleTag::StyleTag(int id, USHORT pagePaletteIndex, int numParams, TStyleParam *param)
	: PliObjectTag(PliTag::STYLE_NGOBJ), m_id(id), m_pageIndex(pagePaletteIndex),
...
StyleTag::StyleTag(const StyleTag &styleTag)
	: PliObjectTag(PliTag::STYLE_NGOBJ), m_id(styleTag.m_id), m_pageIndex(styleTag.m_pageIndex),
...
ColorTag::ColorTag()
	: PliObjectTag(PliTag::COLOR_NGOBJ), m_style(STYLE_NONE), m_attribute(ATTRIBUTE_NONE),
	  m_numColors(0)
{
}
...
ColorTag::ColorTag(ColorTag::styleType style, ColorTag::attributeType attribute, TUINT32 numColors,
				   std::unique_ptr<TUINT32[]> color)
	: PliObjectTag(PliTag::COLOR_NGOBJ), m_style(style), m_attribute(attribute),
	  m_numColors(numColors), m_color(std::move(color))
{
}
/*=====================================================================*/

ColorTag::ColorTag(const ColorTag &tag)
	: PliObjectTag(PliTag::COLOR_NGOBJ), m_style(tag.m_style), m_attribute(tag.m_attribute),
...
IntersectionDataTag::IntersectionDataTag(UINT branchCount,
										 std::unique_ptr<IntersectionBranch[]> branchArray)
	: PliObjectTag(PliTag::INTERSECTION_DATA_GOBJ), m_branchCount(branchCount),
...
StrokeOutlineOptionsTag::StrokeOutlineOptionsTag() : PliObjectTag(OUTLINE_OPTIONS_GOBJ)
{
}
...
ImageTag::ImageTag(const ImageTag &imageTag)
	: PliObjectTag(PliTag::IMAGE_GOBJ), m_numFrame(imageTag.m_numFrame),
...
GeometricTransformationTag::GeometricTransformationTag(
	...
	: PliGeometricTag(PliTag::GEOMETRIC_TRANSFORMATION_GOBJ), m_affine(trasformationTag.m_affine),
...
DoublePairTag::DoublePairTag() : PliObjectTag(PliTag::DOUBLEPAIR_OBJ), m_first(0), m_second(0)
{
}
...
DoublePairTag::DoublePairTag(const DoublePairTag &doublePairTag)
	: PliObjectTag(PliTag::DOUBLEPAIR_OBJ), m_first(doublePairTag.m_first),
