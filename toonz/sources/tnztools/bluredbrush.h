...
class BluredBrush
{
  ...
  public:
	...
	void addArc(const TThickPoint &pa, const TThickPoint &pb, const TThickPoint &pc,
	...
	void eraseDrawing(const TRasterP ras, const TRasterP rasBackup, const TRect &bbox,
