...
class ControlPointEditorStroke
{
  ...
  public:
	...
	*/
	...
	void linkUnlinkSpeeds(int index, bool isCusp) { m_controlPoints[index].m_isCusp = isCusp; }
	...
	/*! Ritorna l'indice del cp il cui bilancino e' piu' vicino al punto pos.
		  ...
		  se la ControlPointEditorStroke e' vuota ritorna -1. \b isIn e' true se il bilancino
	   cliccato
	...
	/*! Se isLinear e' true setta a "0" il valore dello speedIn e il valore dello speedOut;
			altrimenti li setta ad un valore di default. Ritorna vero se almeno un punto e' ststo
	   modificato.*/
