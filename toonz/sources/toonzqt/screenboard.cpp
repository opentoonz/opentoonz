...
{
  public:
	bool acceptScreenEvents(const QRect &rect) const { return rect.contains(QCursor::pos()); }
...
#ifdef MACOSX
#define MIN_ALPHA                                                                                  \
	13 // Again, very weird. 13 is the minimal alpha that gets converted to 'mask-opaque' on MAC...
#else
...
/*!
  ...
  to get them), and delivers them to drawings. An appropriate cursor should be specified to inform
  the
