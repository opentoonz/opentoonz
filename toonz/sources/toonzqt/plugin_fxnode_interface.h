...
int fxnode_get_bbox(toonz_fxnode_handle_t fxnode, const toonz_rendering_setting_t *, double frame,
					toonz_rect_t *rect, int *ret);
int fxnode_can_handle(toonz_fxnode_handle_t fxnode, const toonz_rendering_setting_t *, double frame,
					  int *ret);
