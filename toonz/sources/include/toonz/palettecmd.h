...
DVAPI void findPaletteLevels(std::set<TXshSimpleLevel *> &levels, int &rowIndex, int &columnIndex,
...
DVAPI void arrangeStyles(TPaletteHandle *paletteHandle, int dstPageIndex, int dstIndexInPage,
...
DVAPI void addStyles(TPaletteHandle *paletteHandle, int pageIndex, int indexInPage,
...
DVAPI int loadReferenceImage(TPaletteHandle *paletteHandle, bool replace, const TFilePath &_fp,
							 int &frame, ToonzScene *scene,
