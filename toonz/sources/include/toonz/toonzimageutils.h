...
DVAPI TRect addInkStroke(const TToonzImageP &ti, TStroke *stroke, int inkId, bool selective,
						 bool filled, TRectD clip = TRectD(), bool doAntialiasing = true);
...
// void eraseInkStroke(const TToonzImageP &ti, TStroke *stroke, int maskInkId, TRectD
// clip=TRectD());
...
DVAPI TRect eraseRect(const TToonzImageP &ti, const TRectD &area, int maskId, bool onInk,
					  bool onPaint);
...
DVAPI TToonzImageP vectorToToonzImage(const TVectorImageP &vi, const TAffine &aff,
