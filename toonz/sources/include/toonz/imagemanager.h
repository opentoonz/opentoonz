...
*/
  virtual bool isImageCompatible(int imFlags, BuildExtData *extData);
...
*/
  virtual bool areInfosCompatible(int imFlags, BuildExtData *extData);
...
protected:
  ...
  //! data.
  virtual TImageP build(int imFlags, BuildExtData *extData) = 0;
...
class DVAPI ImageManager final : public QObject {
  Q_OBJECT
