...
DVAPI void insertFx(TFx *newFx, const QList<TFxP> &fxs, const QList<Link> &links, TApplication *app,
					int colunIndex, int rowIndex);
DVAPI void addFx(TFx *newFx, const QList<TFxP> &fxs, TApplication *app, int colunIndex,
				 int rowIndex);
DVAPI void replaceFx(TFx *newFx, const QList<TFxP> &fxs, TXsheetHandle *xshHandle,
					 TFxHandle *fxHandle);
...
DVAPI void connectFxs(const Link &link, const std::list<TFxP> &fxs, TXsheetHandle *xshHandle,
					  const QList<QPair<TFxP, TPointD>> &fxPos);
...
DVAPI void deleteSelection(const std::list<TFxP> &fxs, const std::list<Link> &links,
						   const std::list<int> &columnIndexes, TXsheetHandle *xshHandle,
						   TFxHandle *fxHandle);
DVAPI void pasteFxs(const std::list<TFxP> &fxs, const std::map<TFx *, int> &zeraryFxColumnSize,
...
DVAPI void renameGroup(const std::list<TFxP> &fxs, const std::wstring &name, bool fromEditor,
