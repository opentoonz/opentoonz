...
class DVAPI TQuadDistorter : public TDistorter
{
  ...
  public:
	TQuadDistorter(const TPointD &p00s, const TPointD &p10s, const TPointD &p01s,
		...
		: m_p00s(p00s), m_p10s(p10s), m_p01s(p01s), m_p11s(p11s), m_p00d(p00d), m_p10d(p10d),
		  m_p01d(p01d), m_p11d(p11d)
	{
	}
...
class DVAPI BilinearDistorterBase : public TQuadDistorter
{
  ...
  public:
	BilinearDistorterBase(const TPointD &p00s, const TPointD &p10s, const TPointD &p01s,
						  const TPointD &p11s, const TPointD &p00d, const TPointD &p10d,
						  const TPointD &p01d, const TPointD &p11d);
...
//! of the source corners into the same combinations of destination ones. The resulting image
//! deformation
...
class DVAPI BilinearDistorter : public TQuadDistorter
{
  ...
  public:
	BilinearDistorter(const TPointD &p00s, const TPointD &p10s, const TPointD &p01s,
					  const TPointD &p11s, const TPointD &p00d, const TPointD &p10d,
					  const TPointD &p01d, const TPointD &p11d);
	~BilinearDistorter();
...
class DVAPI PerspectiveDistorter : public TQuadDistorter
{
  ...
  public:
	class DVAPI TPerspect
	{
	  public:
		...
		TPerspect();
		TPerspect(double p11, double p12, double p13, double p21, double p22, double p23,
  ...
  public:
	PerspectiveDistorter(const TPointD &p00s, const TPointD &p10s, const TPointD &p01s,
						 const TPointD &p11s, const TPointD &p00d, const TPointD &p10d,
						 const TPointD &p01d, const TPointD &p11d);
	~PerspectiveDistorter();
  ...
  private:
	...
	//! First is compute a transformation A' starting from m_startPoints to (0,0), (0,1), (1,1),
	//! (1,0);
	//! the a second tranformation A'' is compute starting from (0,0), (0,1), (1,1), (1,0) to
	//! m_endPoints.
	//! The resulting matrix is A'*A''.
	void computeMatrix();
	double determinant(double a11, double a12, double a21, double a22);
	TPerspect computeSquareToMatrix(const TPointD &p00, const TPointD &p10, const TPointD &p01,
									const TPointD &p11);
