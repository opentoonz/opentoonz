...
DVAPI TRect addStroke(const TRasterImageP &ri, TStroke *stroke, TRectD clip, double opacity,
...
DVAPI TRasterImageP vectorToFullColorImage(const TVectorImageP &vi, const TAffine &aff,
...
DVAPI void addGlobalNumbering(const TRasterImageP &ri, const std::wstring &sceneName,
							  int globalIndex);
} // namespace
