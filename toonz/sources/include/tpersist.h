...
//===================================================================
//! This is an abstract class for load and save data from and to the file system (i.e files on the
//! disk)
class DVAPI TPersist
{
  public:
	...
	/*!
		...
		the object loading from a stream (i.e take the object's features from a formatted data
	   stream).
		For example the TStageObject class use his implementation to take the values of the
	   parameters
	...
	*/
	...
	/*!
		This is a pure virtual function and must be overridden with a method that implements
		the object saving to a data stream (i.e put the object's features on a formatted data
	   stream).
		For example the TStageObject class use his implementation to save the values of the
	   parameters
	...
	*/
	...
	/*!
		Returns the string identifier of the object. For example a TXsheet object is identified by
	   "xsheet",
...
/*!
	...
	*/
template <class T> class TPersistDeclarationT : public TPersistDeclaration
{
  public:
	/*!
