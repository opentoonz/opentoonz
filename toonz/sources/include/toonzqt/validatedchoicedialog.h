...
class DVAPI ValidatedChoiceDialog : public DVGui::Dialog
{
  ...
  public:
	...
	ValidatedChoiceDialog(QWidget *parent,
						  Options opts = NO_OPTIONS); //!< Constructs the dialog with no default
													  //!resolutions.               \param parent
													  //!Parent top-level widget.  \param Opts
  ...
  protected:
	...
	virtual void initializeUserInteraction(const void *obj) {} //!< Invoked at max \a once per \p
															   //!execute(), immediately
