...
class TParamUIConcept
{
  public:
	...
	enum Type {
		...
		RADIUS, // Distance from a point (radius). Represented by     { [TDoubleParamP],
				// TPointParamP }
		WIDTH,  // Width, as distance from a line with given angle.   { [TDoubleParamP],
				// TDoubleParamP }
		...
		RECT, // A Rect, with width, height and center.             { [2 TDoubleParamP],
			  // TPointParamP }
