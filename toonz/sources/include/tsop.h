...
/*!
  ...
  */
DVAPI TSoundTrackP convert(const TSoundTrackP &src, const TSoundTrackFormat &dstFormat);
...
/*!
	...
	returns the obtained soundtrack
  */
DVAPI TSoundTrackP reverb(TSoundTrackP src, double delayTime, double decayFactor,
						  double extendTime);
...
/*!
	...
	returns the obtained soundtrack
  */
DVAPI TSoundTrackP gate(TSoundTrackP src, double threshold, double holdTime, double releaseTime);

/*!
	Does the echo effect to the soundtrack src with the specified feature
  */
DVAPI void echo(TSoundTrackP &dst, const TSoundTrackP &src, double delayTime, double decayFactor,
				double extendTime);
...
/*!
  ...
  */
DVAPI TSoundTrackP mix(const TSoundTrackP &st1, const TSoundTrackP &st2, double a1, double a2);
...
/*!
  ...
  */
DVAPI TSoundTrackP crossFade(const TSoundTrackP src1, const TSoundTrackP src2, double crossFactor);
...
/*!
  ...
  */
DVAPI TSoundTrackP crossFade(double crossFactor, const TSoundTrackP src1, const TSoundTrackP src2);
}
