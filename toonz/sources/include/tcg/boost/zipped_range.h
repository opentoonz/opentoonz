...
template <typename Rng1, typename Rng2> struct _zip_rng_traits {
	typedef boost::zip_iterator<boost::tuple<typename boost::range_iterator<Rng1>::type,
...
typename _zip_rng_traits<Rng1, Rng2>::range zipped_range(Rng1 &rng1, Rng2 &rng2)
{
