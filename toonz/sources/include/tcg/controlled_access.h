...
class controlled_access : tcg::noncopyable<>
{
  ...
  public:
	...
	controlled_access(const obj_type &obj, const func_type &func) : m_obj(obj), m_func(func) {}
...
template <typename Obj> class controlled_access<Obj, tcg::empty_type> : tcg::noncopyable<>
{
	Obj m_obj; //!< Stored object.
  ...
  public:
	...
	template <typename Func> const obj_type &operator()(Func func) const
	{
		func(m_obj);
		return m_obj;
	}

	template <typename Func> obj_type &operator()(Func func)
	{
		func(m_obj);
		return m_obj;
	}
...
template <typename Obj, typename Func = tcg::empty_type> class invalidable : tcg::noncopyable<>
{
...
template <typename Obj> class invalidable<Obj, tcg::empty_type> : tcg::noncopyable<>
{
	mutable Obj m_obj;		//!< Stored object
	mutable bool m_invalid; //!< Data validity status
