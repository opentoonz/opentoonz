...
template <typename Fn1, typename Fn2> unary_and<Fn1, Fn2> and1(const Fn1 &fn1, const Fn2 &fn2)
{
...
template <typename Fn1, typename Fn2> unary_or<Fn1, Fn2> or1(const Fn1 &fn1, const Fn2 &fn2)
{
