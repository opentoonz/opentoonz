...
class DVAPI TSegment
{
  ...
  public:
	...
	TSegment(double x0, double y0, double x1, double y1) : m_c0(x0, y0), m_c1(x1 - x0, y1 - y0) {}
	...
	bool operator==(const TSegment &c) const { return m_c0 == c.m_c0 && m_c1 == c.m_c1; };
	...
	bool isPoint(double err2 = TConsts::epsilon) const { return norm2(m_c1) < err2; }
};
...
class DVAPI TQuadratic
{
  ...
  public:
	...
	TQuadratic(const TQuadratic &src) : m_p0(src.m_p0), m_p1(src.m_p1), m_p2(src.m_p2) {}
	...
	TPointD getAcceleration(double = 0) const { return 2.0 * (m_p0 + m_p2 - 2.0 * m_p1); }
...
class DVAPI TCubic
{
  ...
  public:
	...
	TCubic(const TPointD &p0, const TPointD &p1, const TPointD &p2, const TPointD &p3)
		: m_p0(p0), m_p1(p1), m_p2(p2), m_p3(p3)
	{
	}

	TCubic(const TCubic &src) : m_p0(src.m_p0), m_p1(src.m_p1), m_p2(src.m_p2), m_p3(src.m_p3) {}
	...
	TRectD getBBox() const
	{
		return TRectD(tmin(m_p0.x, m_p1.x, m_p2.x, m_p3.x), tmin(m_p0.y, m_p1.y, m_p2.y, m_p3.y),
					  tmax(m_p0.x, m_p1.x, m_p2.x, m_p3.x), tmax(m_p0.y, m_p1.y, m_p2.y, m_p3.y));
	};
...
class DVAPI TThickSegment : public TSegment
{
  ...
  public:
	...
	TThickSegment(const TThickSegment &thickSegment)
		: TSegment(thickSegment), m_thickP0(thickSegment.m_thickP0),
		  m_thickP1(thickSegment.m_thickP1)
	{
	}

	TThickSegment(const TSegment &seg) : TSegment(seg), m_thickP0(0), m_thickP1(0) {}

	TThickSegment(const TPointD &p0, double thickP0, const TPointD &p1, double thickP1)
...
class DVAPI TThickQuadratic : public TQuadratic
{
  ...
  public:
	...
	TThickQuadratic(const TPointD &p0, double thickP0, const TPointD &p1, double thickP1,
					const TPointD &p2, double thickP2);

	TThickQuadratic(const TThickPoint &p0, const TThickPoint &p1, const TThickPoint &p2);
...
inline TThickQuadratic transformQuad(const TAffine &aff, const TThickQuadratic &tq,
...
class DVAPI TThickCubic : public TCubic
{
  ...
  public:
	...
	TThickCubic(const TThickPoint &p0, const TThickPoint &p1, const TThickPoint &p2,
				const TThickPoint &p3);

	//  tonino ***************************************************************
	TThickCubic(const T3DPointD &p0, const T3DPointD &p1, const T3DPointD &p2, const T3DPointD &p3);
