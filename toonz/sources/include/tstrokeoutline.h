...
struct TOutlinePoint {
  ...
  */
	...
	double u, v; //  coordinate di texture del punto (v = "ascissa curvilinea", u = "parametro di
				 //  ampiezza")
	// TPointD tangent;  //  vettore tangente alla centerline (nel punto che ha lo stesso parametro
	// 't' (approssimazione...))
	// TPointD normal; //  vettore normale alla centerline (nel punto che ha lo stesso parametro 't'
	// (approssimazione...))
