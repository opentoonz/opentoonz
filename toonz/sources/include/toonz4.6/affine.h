...
#define AFF_EQ(A, B)                                                                               \
	((A).a11 == (B).a11 && (A).a12 == (B).a12 && (A).a13 == (B).a13 && (A).a21 == (B).a21 &&       \
	 (A).a22 == (B).a22 && (A).a23 == (B).a23)
...
#define ROTATE_POST(ang, cxin, cyin, cxout, cyout, aff)                                            \
	aff_mult(aff, aff_shift(cxout, cyout, aff_rot(ang, aff_shift(-cxin, -cyin, Aff_I))))
...
#define SCALE_POST(sx, sy, cxin, cyin, cxout, cyout, aff)                                          \
	aff_mult(aff, aff_shift(cxout, cyout, aff_scale(sx, sy, aff_shift(-cxin, -cyin, Aff_I))))
