...
#define CASM_USAGE_MASK                                                                            \
	...
	" -step%d -range%d%d -r%d%d -mem%f -tile%f -64bit -32bit -lineart%d -edgealiasing%d "          \
	"-ddr%d" CASM_LINK_MASK_STRING                                                                 \
...
#define CASM_USAGE_STRING                                                                          \
	...
	"-ddr startframe   : direct output frames on a Digital Disc Recorder starting from specified " \
	"position.\n"                                                                                  \
