...
class DVAPI TMono8SignedSample
{
  ...
  public:
	...
	inline double getPressure(TSound::Channel chan) const { return (getValue(chan)); }
...
inline TMono8SignedSample operator+(const TMono8SignedSample &s1, const TMono8SignedSample &s2)
{
...
class DVAPI TMono8UnsignedSample
{
  ...
  public:
	...
	inline double getPressure(TSound::Channel chan) const { return (getValue(chan) - 128); }
...
class DVAPI TStereo8SignedSample
{
  ...
  public:
	...
	inline TStereo8SignedSample operator*(double a) { return TStereo8SignedSample(*this) *= a; }
...
class DVAPI TStereo8UnsignedSample
{
  ...
  public:
	...
	inline double getPressure(TSound::Channel chan) const { return (((int)getValue(chan)) - 128); }
	...
	inline TStereo8UnsignedSample operator*(double a) { return TStereo8UnsignedSample(*this) *= a; }
...
class DVAPI TMono16Sample
{
  ...
  public:
	...
	static TMono16Sample mix(const TMono16Sample &s1, double a1, const TMono16Sample &s2, double a2)
	{
...
inline TMono16Sample operator+(const TMono16Sample &s1, const TMono16Sample &s2)
{
	TMono16Sample s = s1;
	return s += s2;
}
...
class DVAPI TStereo16Sample
{
  ...
  public:
	...
	inline TStereo16Sample operator*(double a) { return TStereo16Sample(*this) *= a; }

	static TStereo16Sample mix(const TStereo16Sample &s1, double a1, const TStereo16Sample &s2,
							   double a2)
	{
...
inline TStereo16Sample operator+(const TStereo16Sample &s1, const TStereo16Sample &s2)
{
...
class DVAPI TMono24Sample
{
  ...
  public:
	...
	static TMono24Sample mix(const TMono24Sample &s1, double a1, const TMono24Sample &s2, double a2)
	{
...
inline TMono24Sample operator+(const TMono24Sample &s1, const TMono24Sample &s2)
{
	TMono24Sample s = s1;
	return s += s2;
}
...
class DVAPI TStereo24Sample
{
  ...
  public:
	...
	inline TStereo24Sample operator*(double a) { return TStereo24Sample(*this) *= a; }

	static TStereo24Sample mix(const TStereo24Sample &s1, double a1, const TStereo24Sample &s2,
							   double a2)
	{
...
inline TStereo24Sample operator+(const TStereo24Sample &s1, const TStereo24Sample &s2)
{
...
{
	return TMono8SignedSample((sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) >>
							  1);
}
...
{
	return TMono8UnsignedSample((sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) >>
								1);
}
...
{
	return TMono8UnsignedSample(
		(unsigned char)((sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) >> 17) +
		128);
}
...
{
	int srcval = ((sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) >> 1) - 128;
	return TStereo8SignedSample(srcval, srcval);
}
...
{
	int srcval = (sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) >> 9;
	return TStereo8SignedSample(srcval, srcval);
}
...
{
	int srcval = (sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) >> 17;
	return TStereo8SignedSample(srcval, srcval);
}
...
{
	int srcval = ((sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) >> 9) + 128;
	return TStereo8UnsignedSample(srcval, srcval);
}
...
{
	int srcval = ((sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) >> 17) + 128;
	return TStereo8UnsignedSample(srcval, srcval);
}
...
{
	return TMono16Sample((sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) << 7);
}
...
{
	return TMono16Sample((sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT) - 256)
						 << 7);
}
...
{
	return TMono16Sample((sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) >> 1);
}
...
{
	int srcval = (sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT) - 256) << 7;
	return TStereo16Sample(srcval, srcval);
}
...
{
	int srcval = (sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) << 15;
	return TMono24Sample(srcval);
}
...
{
	int srcval = (sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT) - 256) << 15;
	return TMono24Sample(srcval);
}
...
{
	int srcval = (sample.getValue(TSound::LEFT) + sample.getValue(TSound::RIGHT)) >> 1;
	return TMono24Sample(srcval);
}
