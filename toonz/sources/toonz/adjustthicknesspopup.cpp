		...
		if (startIdx <= endIdx) {
			...
			switch (selData.m_contentType) {
				...
				CASE SelectionData::STYLES:
				{
					...
					::transformThickness_styles(viOut, transform, &selData.m_idxs.front(),
												selData.m_idxs.size());
				}
				...
				CASE SelectionData::BOUNDARIES:
				{
					...
					::transformThickness_strokes(viOut, transform, &strokes.front(),
												 strokes.size());
				}

				CASE SelectionData::STROKES:
				{
					::transformThickness_strokes(viOut, fromTransform, &selData.m_idxs.front(),
												 selData.m_idxs.size());
				}
