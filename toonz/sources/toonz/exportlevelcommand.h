...
TImageP
exportedImage(const std::string &ext,	//!< File extension - like \a tga, \a tlv, \a png, etc...
...
/*!
  ...
  \details  This function performs level export depending on the specified path's extension,
			...
			This function allows external callbacks to deal with overwrite and progress
  notifications.
