...
QImage XsheetViewer::getXsheetCamstandButtonOnImage() const {
	static QImage iconImage = svgToPixmap(":Resources/x_table_view.svg").toImage();
...
QImage XsheetViewer::getXsheetCamstandButtonTranspImage() const {
	static QImage iconImage = svgToPixmap(":Resources/x_table_view_transp.svg").toImage();
...
QImage XsheetViewer::getTimelinePreviewButtonOnImage() const {
	if (m_timelinePreviewButtonOnImage.isNull()) return getXsheetPreviewButtonOnImage();
	return m_timelinePreviewButtonOnImage;
}

QImage XsheetViewer::getTimelineCamstandButtonOnImage() const {
	if (m_timelineCamstandButtonOnImage.isNull()) return getXsheetCamstandButtonOnImage();
	return m_timelineCamstandButtonOnImage;
}

QImage XsheetViewer::getTimelineCamstandButtonTranspImage() const {
	if (m_timelineCamstandButtonTranspImage.isNull()) return getXsheetCamstandButtonTranspImage();
...
QImage XsheetViewer::getLayerHeaderPreviewImage() const {
	if (m_layerHeaderPreviewImage.isNull()) return getXsheetPreviewButtonOnImage();
	return m_layerHeaderPreviewImage;
}

QImage XsheetViewer::getLayerHeaderCamstandImage() const {
	if (m_layerHeaderCamstandImage.isNull()) return getXsheetCamstandButtonOnImage();
