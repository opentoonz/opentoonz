	...
	if (event->buttons() == Qt::LeftButton) {
		...
		if (dragEnum == NODRAG)
			...
			case DRAG_RIGHT:
				...
				CASE DRAG_LEFT | DRAG_TOP : case DRAG_RIGHT |
											DRAG_BOTTOM : viewer->setCursor(Qt::SizeFDiagCursor);
				CASE DRAG_LEFT | DRAG_BOTTOM : case DRAG_RIGHT |
											   DRAG_TOP : viewer->setCursor(Qt::SizeBDiagCursor);
			DEFAULT:
				viewer->setCursor(Qt::ArrowCursor);
			}
	}
