...
{
IGS_PERLIN_NOISE_EXPORT void change(unsigned char *image_array, const int height // pixel
									,
									...
									,
									const double a12 = 0.0, const double a13 = 0.0,
									const double a21 = 0.0, const double a22 = 0.01,
