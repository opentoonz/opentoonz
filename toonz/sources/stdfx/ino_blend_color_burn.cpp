...
class ino_blend_color_burn : public TBlendForeBackRasterFx
{
  ...
  public:
	ino_blend_color_burn() : m_opacity(1.0 * ino::param_range()), m_clipping_mask(true)
	{
...
void ino_blend_color_burn::computeUpAndDown(TTile &tile, double frame, const TRenderSettings &rs,
...
void ino_blend_color_burn::doCompute(TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
