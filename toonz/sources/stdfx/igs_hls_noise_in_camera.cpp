...
{
  public:
	noise_reference(const int ww, const int hh, const double hue_range, const double lig_range,
					const double sat_range, const double alp_range, const unsigned long random_seed,
...
void pixel_rgb(const double red_in, const double gre_in, const double blu_in, const double alp_in,
			   ...
			   control_term_within_limits &lig_term, control_term_within_limits &sat_term,
...
void igs::hls_noise_in_camera::pixel_rgb(const double red_in, const double gre_in,
										 const double blu_in, const double alp_in,
										 const double hue_noise, const double lig_noise,
										 const double sat_noise,
...
void igs::hls_noise_in_camera::pixel_a(const double alp_in, const double alp_noise,
...
void igs::hls_noise_in_camera::change(
	...
	,
	const double hue_range, const double lig_range, const double sat_range, const double alp_range,
	...
	const double alp_effective, const double alp_center, const int alp_type)
{
	...
	/* ノイズ参照画像を作成する */
	noise_reference noise(width, height, hue_range, lig_range, sat_range, alp_range, random_seed,
						  near_blur, camera_x, camera_y, camera_w, camera_h);

	/* 端値を適度に調整する設定 */
	control_term_within_limits lig_term(lig_effective, lig_effective, lig_center, lig_type,
										lig_range);
	...
	if (std::numeric_limits<unsigned char>::digits == bits) {
		change_template_(static_cast<unsigned char *>(image_array), width, height, channels, noise,
						 hue_range, lig_term, sat_term, alp_term);
