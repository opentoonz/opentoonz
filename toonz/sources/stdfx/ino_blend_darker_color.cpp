...
class ino_blend_darker_color : public TBlendForeBackRasterFx
{
  ...
  public:
	ino_blend_darker_color() : m_opacity(1.0 * ino::param_range()), m_clipping_mask(false)
	{
...
void ino_blend_darker_color::computeUpAndDown(TTile &tile, double frame, const TRenderSettings &rs,
...
void ino_blend_darker_color::doCompute(TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
