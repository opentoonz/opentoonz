...
class ino_blend_color_dodge : public TBlendForeBackRasterFx
{
  ...
  public:
	ino_blend_color_dodge() : m_opacity(1.0 * ino::param_range()), m_clipping_mask(true)
	{
...
void ino_blend_color_dodge::computeUpAndDown(TTile &tile, double frame, const TRenderSettings &rs,
...
void ino_blend_color_dodge::doCompute(TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
