...
class EmbossFx : public TStandardRasterFx
{
  ...
  public:
	EmbossFx() : m_intensity(0.5), m_elevation(45.0), m_direction(90.0), m_radius(1.0)
	{
...
void doEmboss(TRasterPT<PIXEL> ras, TRasterPT<PIXEL> srcraster, double azimuth, double elevation,
...
void EmbossFx::doCompute(TTile &tile, double frame, const TRenderSettings &ri)
{
	...
	if (raster32)
		...
		if (raster64)
			doEmboss<TPixel64, TPixelGR16, USHORT>(raster64, srcraster64, azimuth, elevation,
												   intensity, radius);
		else
