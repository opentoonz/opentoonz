...
void ino_blend_add::computeUpAndDown(TTile &tile, double frame, const TRenderSettings &rs,
...
void ino_blend_add::dryComputeUpAndDown(TRectD &rect, double frame, const TRenderSettings &rs,
...
void ino_blend_add::doCompute(TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
