...
class ino_blend_over : public TBlendForeBackRasterFx
{
  ...
  public:
	ino_blend_over() : m_opacity(1.0 * ino::param_range()), m_clipping_mask(false)
	{
...
void ino_blend_over::computeUpAndDown(TTile &tile, double frame, const TRenderSettings &rs,
									  TRasterP &dn_ras, TRasterP &up_ras, bool upComputesWholeTile)
{
...
void ino_blend_over::dryComputeUpAndDown(TRectD &rect, double frame, const TRenderSettings &rs,
...
void ino_blend_over::doCompute(TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
