...
class ino_blend_linear_light : public TBlendForeBackRasterFx
{
  ...
  public:
	ino_blend_linear_light() : m_opacity(1.0 * ino::param_range()), m_clipping_mask(true)
	{
...
void ino_blend_linear_light::computeUpAndDown(TTile &tile, double frame, const TRenderSettings &rs,
...
void ino_blend_linear_light::doCompute(TTile &tile, double frame, const TRenderSettings &rs)
{
	/* ------ 画像生成 ---------------------------------------- */
